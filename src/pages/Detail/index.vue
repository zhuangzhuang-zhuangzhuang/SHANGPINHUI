            ...
            <div class="chooseArea">
              ...
              >
                ...
                <dd
                  ...
                  :key="spuSale.id"
                  @click="
                    changeChecked(spuSaleAttr.spuSaleAttrValueList, spuSale)
                  "
                >
...
export default {
  ...
  methods: {
    getDeailInfo(skuId) {
      this.$store.dispatch("getDeailInfo", this.skuId);
    },
    //用户点击属性值的回调函数
    changeChecked(spuSaleAttrValueList, spuSale) {
    ...
    async toShopCar() {
      try {
        await this.$store.dispatch("getShopCar", {
          skuId: this.skuId,
          skuNum: this.skuNum,
        });
        //浏览器本地存贮，关闭浏览器就销毁
